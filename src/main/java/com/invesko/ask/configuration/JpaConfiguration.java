package com.invesko.ask.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.invesko.ask.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.invesko.ask.model" });
